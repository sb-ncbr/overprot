...
export namespace OverProtViewerCore {
    ...
    export function initializeViewer(htmlElement: HTMLElement): void {
        ...
        let viewer: Types.Viewer = Types.newViewer(d3mainDiv, d3guiDiv, d3canvas, settings);
    ...
    function initializeExternalControls(viewer: Types.Viewer, uniqueId: string): void {
    ...
    function refreshVisualization(viewer: Types.Viewer): void {
        ...
        Drawing.addPointBehavior(d3nodeShapes, shape => d3.select(shape.parentElement) as any);
