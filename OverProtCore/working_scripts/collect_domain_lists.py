...
def parse_args() -> Dict[str, Any]:
    ...
    parser.add_argument('datadir', help='Directory generated by overprot_multifamily.py', type=str)
    parser.add_argument('output', help=f'Output file', type=str)
    parser.add_argument('--orig', help=f'Take family-orig.json instead of family.json', action='store_true')
    args = parser.parse_args()
    return vars(args)


def main(datadir: str, output: str, orig: bool = False) -> Optional[int]:
    '''Foo'''
    # TODO add docstring
    family_dirs = sorted(Path(datadir, 'families').iterdir())
