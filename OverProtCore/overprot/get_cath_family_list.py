...
def main(cath_domain_list: Path, download: bool = False, url: str = CATH_DOMAIN_LIST_URL, 
         output: Optional[Path] = None, sort_by_size: bool = False) -> Optional[int]:
    ...
    with open(cath_domain_list,) as f:
        for line in f:
