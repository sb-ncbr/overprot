...
namespace Cif.Tables
{
    ...
    public class OldAtomTable
    {
        ...
        public OldAtomTable (CifBlock cifBlock) : this(cifBlock[CATEGORY_NAME]) { }

        public OldAtomTable (CifBlock cifBlock, int[] rows) : this(cifBlock[CATEGORY_NAME], rows) { }

        public OldAtomTable (CifCategory cifCategory){
            // Mandatory data items
            try {
        ...
        public OldAtomTable (CifCategory cifCategory, int[] rows){
            // Mandatory data items
            try {
