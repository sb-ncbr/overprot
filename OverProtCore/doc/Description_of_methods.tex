...
\item
  ...
  MAPSCI consensus structure via \code{cealign} algorithm {[}cite Shindyalov
...
the Integrated Viewer in the OverProt web (\path{https://overprot.ncbr.muni.cz/static/integration/index.html?family_id=1.10.630.10&domain_id=1jfbA00})
